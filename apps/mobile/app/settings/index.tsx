    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: isDark ? '#0B0B0A' : '#FBFAF8' }}>
      ...
      <ScrollView>
        ...
        <SettingsSection title={t('settings:howYouUseFindEat')}>
          ...
          <SettingsRow icon={<GlobeHemisphereWestIcon size={23} color="#D1A928" weight="duotone" />} title={t('settings:discoveryCountry')} subtitle={t('settings:discoveryCountrySubtitle')} value={activeCountry?.name} onPress={() => router.push('/country-picker')} />
