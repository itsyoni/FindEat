...
const permissionCopy: Record<RestaurantPermission, { title: string; detail: string }> = {
  ...
  MANAGE_OFFERS: { title: "Offers & rewards", detail: "Create and manage offers, rewards, and redemptions." },
  MANAGE_RESERVATIONS: { title: "Reservations", detail: "Manage tables, guests, booking details, and reservation status." },
