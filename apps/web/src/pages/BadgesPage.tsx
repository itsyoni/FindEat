...
export function BadgesPage({ restaurant }: { restaurant: ManagedRestaurant }) {
  ...
  return <section className="flex h-full min-h-0 w-full flex-col overflow-hidden p-8.5 max-[700px]:overflow-y-auto max-[700px]:px-4.5 max-[700px]:py-5.5 max-[380px]:px-3">
    ...
    {badges.length === 0 ? <div className="grid min-h-0 flex-1 place-content-center rounded-3xl border border-dashed border-line p-6 text-center max-[700px]:min-h-72 max-[380px]:p-4">
    ...
    </div> : <div className="grid min-h-0 flex-1 grid-cols-2 content-start gap-4 overflow-hidden max-[700px]:grid-cols-1 max-[700px]:overflow-visible">
