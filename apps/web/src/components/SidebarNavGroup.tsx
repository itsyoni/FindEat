  ...
  return (
    <div className="min-w-0 max-[800px]:col-span-full" data-sidebar-group>
      <button
        ...
        aria-expanded={open}
        aria-controls={id}
        className={`flex min-h-11 w-full items-center gap-3.25 rounded-xl border-0 bg-transparent p-3 text-left text-sm text-[#faf9f6] transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent [@media(hover:hover)]:hover:translate-x-0.75 [@media(hover:hover)]:hover:bg-[#ffffff1a] ${active ? "font-black tracking-[-0.012em]" : "font-bold"}`}
        onClick={(event) => {
